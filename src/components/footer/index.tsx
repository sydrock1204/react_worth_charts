            ...
            <div className="flex flex-row">
                ...
                <div className="flex flex-col ml-8 w-4/6">
                    <div className="flex flex-row border-b-2 border-color-white gap-4 h-[116px]">
                        ...
                        <BaseButton text="subscribe" className="mt-[33px] h-[43px] w-[164px]  bg-color-brand-green border-color-brand-green border-2 font-mono text-xl"/>
                        {!session && (
                        <BaseButton
                            text="login"
                            className="mt-[33px] w-[114px]  h-[43px] bg-transparent border-color-brand-green border-2 font-mono text-xl"
                            onClick={() => {
                            navigate('/auth/login')
                            }}
                        />
